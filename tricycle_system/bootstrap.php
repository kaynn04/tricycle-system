    ...
    <form class="form-horizontal">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="LName" value="<?php echo $userInfo['LName']; ?>" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">First Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="FName" value="<?php echo $userInfo['FName']; ?>" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Middle Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="MName" value="<?php echo $userInfo['MName']; ?>" readonly>
                </div>
            </div>
            <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-sm-10 col-sm-offset-5">
            <a href="bootstrap_edit.php"> <button type="button" class="btn btn-primary">Edit Information</button></a>
        </div>
    </div>
</div>
</div>
